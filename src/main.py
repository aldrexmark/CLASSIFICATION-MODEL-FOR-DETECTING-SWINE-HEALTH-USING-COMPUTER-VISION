...
#PATHS
DB_PATH = os.path.join(BASE_DIR, "src", "detected.db")  
IMAGE_PATH = os.path.join(BASE_DIR, "src", "images") 

BELL_SOUND_PATH = os.path.join(BASE_DIR, "src", "bell_sound.mp3")
WEIGHTS_PATH = os.path.join(BASE_DIR, "lib", "dnn_model", "yolov4-tiny.weights")
CFG_PATH = os.path.join(BASE_DIR, "lib", "dnn_model", "yolov4-tiny.cfg")
CLASSES_PATH = os.path.join(BASE_DIR, "lib", "dnn_model", "classes.txt")
BG_PATH = os.path.join(BASE_DIR, "pictures", "bg.png")
PLACEHOLDER_VIDEO_PATH = os.path.join(BASE_DIR, "pictures", "placeholder_image.png")
PICTURE_IMAGE_WINDOW_PATH = os.path.join(BASE_DIR, "pictures", "icon.png")
MODEL_PATH = os.path.join(BASE_DIR, "lib", "best.pt")
PLACEHOLDER_PATH = (BASE_DIR, "pictures", "placeholder_image.png")
ICON_PATH = os.path.join(BASE_DIR, "pictures", "icon.png")
PIC_1_PATH = os.path.join(BASE_DIR, "pictures", "pic_1.png")
CAMERA_LOGO_PATH = os.path.join(BASE_DIR, "pictures", "camera_icon.png")
PIC_2_PATH = os.path.join(BASE_DIR, "pictures", "pic_2.png")
...
class VideoProcessingWindow(tk.Toplevel):
    def __init__(self, master=None):
        ...
        self.placeholder_path_video = PLACEHOLDER_VIDEO_PATH
        ...
        # Add a picture
        picture_image_window_path = PICTURE_IMAGE_WINDOW_PATH
...
class ImageProcessingWindow(tk.Toplevel):
    def __init__(self, master=None):
        ...
        # Add a picture
        picture_image_window_path = ICON_PATH
        original_picture_image_window = Image.open(picture_image_window_path)
        resized_picture_image_window = original_picture_image_window.resize((80, 80), Image.LANCZOS)
...
background_image = ImageTk.PhotoImage(Image.open(BG_PATH))
background_label = tk.Label(root, image=background_image)
background_label.place(x=0, y=0, relwidth=1, relheight=1)

# Load and resize the image using Pillow
image_path = PIC_1_PATH
...
camera_logo_image_path = CAMERA_LOGO_PATH
